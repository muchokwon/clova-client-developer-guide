...
| `token`                  | string  | The token of the audio stream. <div class="note"><p><strong>Caution!</strong></p><p>The maximum length of this field is 2048 bytes.</p></div>                          | Required/Always |
| `url`                    | string  | The audio stream URI.<div class="note"><p><strong>Note!</strong></p><p>The provided audio content must be in an <a href="/Design/Sound.md#SupportedAudioFormat">audio compression format supported by the platform</a>.</p></div><div class="note"><p><strong>Caution!</strong></p><p>The maximum length of this field is 2048 bytes.</p></div>  | Required/Always |
