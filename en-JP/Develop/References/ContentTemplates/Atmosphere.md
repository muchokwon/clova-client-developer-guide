...
| `halfDayAtmosphereList[].atmosphereImageUrl` | [URLObject](/Develop/References/ContentTemplates/Shared_Objects.md#URLObject) | The URL to the image associated with the atmosphere information specified by the `halfDayAtmosphereList[].durationHalfDay` field. |
