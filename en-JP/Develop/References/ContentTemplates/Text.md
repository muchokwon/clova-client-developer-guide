...
|---------------|---------|-----------------------------|
| `bgUrl`                  | [URLObject](/Develop/References/ContentTemplates/Shared_Objects.md#URLObject)       | The URL of the image to display in the background. The `value` field of this object can have an empty string (`""`).               |
...
| `tableList[].item2Link` | [URLObject](/Develop/References/ContentTemplates/Shared_Objects.md#URLObject) or [PhoneNumberObject](/Develop/References/ContentTemplates/Shared_Objects.md#PhoneNumberObject) | The URL link for the text displayed in the second row or phone number. The `value` field of this object can have an empty string (`""`). |
