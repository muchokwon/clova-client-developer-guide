...
The Green Dot VUI motion must be expressed according to the user action or the change of the [client state](/Design/Client_State_And_Event.md). Below are the explanations of the rules on how Green Dot VUI must be expressed according to each state.
...
* Once the client enters the **Listening** mode as the actual voice of the user starts to be entered, repeat the **Listening** motion until the voice input of the user is completed.
