...
| `negativeButtonUrl`    | [URIObject](/Develop/References/ContentTemplates/Shared_Objects.md#URIObject)       | For popups, the URI information to connect to the button label that carries a negative meaning such as **No**. The `value` field of this object can have an empty string (`""`). |
...
| `positiveButtonUrl`   | [URIObject](/Develop/References/ContentTemplates/Shared_Objects.md#URIObject)       | For popups, the URI information to connect to the button label that carries a positive meaning such as **Yes**. For popups with a single button, this object is used as the URI to connect to the button with a meaning such as **Confirmation**. The `value` field of this object can have an empty string (`""`). |
...
| `toastLinkUrl`     | [URIObject](/Develop/References/ContentTemplates/Shared_Objects.md#URIObject)       | The URI of the link to display on the toast. The `value` field of this object can have an empty string (`""`). |
