...
| `cardList[].pressIconUrl`   | [URIObject](/Develop/References/ContentTemplates/Shared_Objects.md#URIObject)             | The URI to the news press icon. The `value` field of this object may have an empty string (`""`) depending on the card type.    |
...
| `noticeLink`                | [URIObject](/Develop/References/ContentTemplates/Shared_Objects.md#URIObject)             | An object which carries the URI of the detailed description page or the source for the content contained in the `noticeText` field. The `value` field of this object can have an empty string (`""`). **If the `value` field value of this object is not an empty string (`""`), the link must be displayed on the screen.**  |
| `noticeText`                | [StringObject](/Develop/References/ContentTemplates/Shared_Objects.md#StringObject)       | The details related to copyright or legal matters with the content. The `value` field of this object can have an empty string (`""`). **If the `value` field value of this object is not an empty string (`""`), it must be displayed on the screen.**  |
